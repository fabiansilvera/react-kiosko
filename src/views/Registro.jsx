...
export default function Registro() {
  ...
  return (
    <>
      <h1 className="text-4xl font-bold mt-5 md:mt-0 text-center">Crea tu Cuenta</h1>
      ...
      <div className="bg-orange-400 shadow-lg rounded-md mt-5 px-5 py-5 font-bold">
        ...
        >
          ...
          <input 
            type="submit"
            value={cargando ? "Cargando..." : "Crear Cuenta"} // Cambia el texto del botón mientras se carga
